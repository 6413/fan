struct stage {
  ...
  struct stage1_t : stage_common_t_t<stage1_t> {
    ...
    hitbox_mouse_button_cb_table_t hitbox_mouse_button_cb_table[1] = {&stage1_t::hitbox0_mouse_button_cb,};
    hitbox_mouse_move_cb_table_t hitbox_mouse_move_cb_table[1] = {&stage1_t::hitbox0_mouse_move_cb,};
    hitbox_keyboard_cb_table_t hitbox_keyboard_cb_table[1] = {&stage1_t::hitbox0_keyboard_cb,};
    hitbox_text_cb_table_t hitbox_text_cb_table[1] = {&stage1_t::hitbox0_text_cb,};
  ...
  struct stage2_t : stage_common_t_t<stage2_t> {
    ...
    typedef int(stage2_t::* button_mouse_button_cb_table_t)(const loco_t::mouse_button_data_t& v);

    button_mouse_button_cb_table_t button_mouse_button_cb_table[1] = {&stage2_t::button0_click_cb,};
