...
fan::vec2 fan_2d::rectangle::move(uint_t i, f32_t speed, f32_t gravity, f32_t jump_force, f32_t friction)
{
	return fan_2d::move_object(this->m_camera->m_window, m_position[i], m_velocity[i], speed, gravity, jump_force, friction);
}
