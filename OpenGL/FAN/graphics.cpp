...
fan_2d::line::line() : basic_single_shape(fan::shader(shader_paths::single_shapes_path_vs, shader_paths::single_shapes_path_fs), fan::vec2(), fan::vec2()), fan_2d::basic_single_color() {}

fan_2d::line::line(const fan::mat2& begin_end, const fan::color& color)
	: basic_single_shape(fan::shader(shader_paths::single_shapes_path_vs, shader_paths::single_shapes_path_fs), begin_end[0], begin_end[1]),
...
fan_2d::square::square()
	: basic_single_shape(
		fan::shader(shader_paths::single_shapes_path_vs, shader_paths::single_shapes_path_fs),
		fan::vec2(),
		fan::vec2()
...
fan_2d::bloom_square::bloom_square()
	: fan_2d::basic_single_shape(fan::shader(shader_paths::single_bloom_shapes_path_vs, shader_paths::single_bloom_shapes_path_fs), fan::vec2(), fan::vec2())
{
...
fan_2d::sprite::sprite() :
	basic_single_shape(fan::shader(shader_paths::single_sprite_path_vs, shader_paths::single_sprite_path_fs), fan::vec2(), fan::vec2()) {}

fan_2d::sprite::sprite(const std::string& path, const fan::vec2& position, const fan::vec2& size)
	: basic_single_shape(fan::shader(shader_paths::single_sprite_path_vs, shader_paths::single_sprite_path_fs), position, size) {
...
fan_2d::animation::animation(const fan::vec2& position, const fan::vec2& size) : basic_single_shape(fan::shader(shader_paths::single_sprite_path_vs, shader_paths::single_sprite_path_fs), position, size) {}
...
void fan::get_fps(bool title, bool print) {
	...
	fan_2d::frame_projection = fan::ortho(fan::window_size.x / 2, fan::window_size.x + fan::window_size.x * 0.5f, fan::window_size.y + fan::window_size.y * 0.5f, fan::window_size.y / 2.f, 0.1f, 1000.0f);
