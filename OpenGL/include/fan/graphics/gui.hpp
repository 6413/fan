	...
	namespace graphics {
		...
		namespace gui {
			...
			namespace base {
				...
				{ \
					const f_t font_size = fan_2d::graphics::gui::text_renderer::get_font_size(i); \
																								  \
					f_t h = (std::abs(fan_2d::graphics::gui::text_renderer::get_highest(font_size) + fan_2d::graphics::gui::text_renderer::get_lowest(font_size))); \
																																									\
