...
#ifndef __abort
  #define __abort() throw "bll_types err"
#endif
...
#define __platform_libc
  ...
  inline unsigned char __clz32(unsigned long p0)
  {
    ...
    if (_BitScanReverse(&trailing_zero, p0)) {
      return unsigned char((DWORD)31 - trailing_zero);
    }
    else {
      return 0;
    }
...
#ifndef __clz64
inline unsigned char __clz64(unsigned long long p0) {
#if defined(__GNUC__)
  ...
  if (_BitScanReverse64(&trailing_zero, p0)) {
    return unsigned char((DWORD)63 - trailing_zero);
  }
  else {
    return 0;
  }
...
inline unsigned char __clz(unsigned long long p0) {
  ...
  inline unsigned char __fast_8log2(unsigned char v){
    return 31 - __clz32(v);
  }
#endif
#ifndef __fast_16log2
  #define __fast_16log2 __fast_16log2
  inline unsigned char __fast_16log2(unsigned short v){
    return 31 - __clz32(v);
  }
#endif
#ifndef __fast_32log2
  #define __fast_32log2 __fast_32log2
  inline unsigned char __fast_32log2(unsigned long v){
    return 31 - __clz32(v);
  }
#endif
#ifndef __fast_64log2
  #define __fast_64log2 __fast_64log2
  inline unsigned char __fast_64log2(unsigned long long v){
    return 63 - __clz64(v);
  }
#endif
#ifndef __fast_log2
