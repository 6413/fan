...
#define context_build_image_functions(build_function) \
  ...
  build_function(image_reload_path, void, fan::graphics::image_nr_t nr, fan::str_view_t path, const std::source_location& callers_path) \
  build_function(image_reload_path_props, void, fan::graphics::image_nr_t nr, fan::str_view_t path, const image_load_properties_t& p, const std::source_location& callers_path) \
