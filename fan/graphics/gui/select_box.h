    ...
    namespace gui {
      ...
      struct select_box_t {
        ...
        void open(fan::window_t* window, fan::opengl::context_t* context, const open_properties_t& p) {
          ...
          m_select_box.m_button_event.set_on_input(this, [](fan::window_t* window, fan::opengl::context_t* context, uint32_t i, int key, fan::key_state key_state, fan_2d::graphics::gui::mouse_stage mouse_stage, void* user_ptr) {
