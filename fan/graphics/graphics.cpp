...
fan::graphics::image_nr_t fan::graphics::image_load(const std::string& path) {
  return gloco->image_load(path);
}

fan::graphics::image_nr_t fan::graphics::image_load(const std::string& path, const fan::graphics::image_load_properties_t& p) {
