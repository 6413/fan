...
imageInfo.imageView = gloco->unloaded_image.get().image_view;
imageInfo.sampler = gloco->unloaded_image.get().sampler;
...
VkSampler sampler;
loco_t::image_t::createTextureSampler(sampler);

imageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
imageInfo.imageView = gloco->get_context().vai_bitmap[0].image_view;
...
imageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
imageInfo.imageView = gloco->get_context().vai_bitmap[1].image_view;
imageInfo.sampler = sampler;
...
//imageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
//imageInfo.imageView = gloco->get_context().vai_bitmap.image_view;
//imageInfo.sampler = sampler;
...
VkDescriptorImageInfo imageInfo{};
imageInfo.imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
imageInfo.imageView = gloco->get_context().vai_wboit_color.image_view;
imageInfo.sampler = sampler;
...
imageInfo.imageView = gloco->get_context().vai_wboit_reveal.image_view;
