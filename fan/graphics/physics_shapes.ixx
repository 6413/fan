...
export namespace fan::graphics::physics {
  ...
  fan::graphics::physics::character2d_t character_circle(
    ...
    return fan::graphics::physics::circle_t(p);
  }
  ...
  fan::graphics::physics::character2d_t character_circle_sprite(
    ...
    p.shape_properties = physics_properties;
    p.body_type = fan::physics::body_type_e::dynamic_body;
    return fan::graphics::physics::circle_sprite_t(p);
  }
  fan::graphics::physics::character2d_t character_capsule(
    ...
    fan::graphics::physics::character2d_t character{ fan::graphics::physics::capsule_t{{
      .position = position,
      .center0 = center0,
      .center1 = center1,
      .radius = radius,
  ...
  fan::graphics::physics::character2d_t character_capsule(
    ...
    p.shape_properties = physics_properties;
    p.body_type = fan::physics::body_type_e::dynamic_body;
    return fan::graphics::physics::capsule_t(p);
  }
  ...
  fan::graphics::physics::character2d_t character_capsule_sprite(
    ...
    p.shape_properties = physics_properties;
    p.body_type = fan::physics::body_type_e::dynamic_body;
    return fan::graphics::physics::capsule_sprite_t(p);
  }
  ...
  fan::graphics::physics::character2d_t character_rectangle(
    ...
    p.shape_properties = physics_properties;
    p.body_type = fan::physics::body_type_e::dynamic_body;
    return fan::graphics::physics::rectangle_t(p);
  }
  ...
  fan::graphics::physics::character2d_t character_sprite(
    ...
    p.shape_properties = physics_properties;
    p.body_type = fan::physics::body_type_e::dynamic_body;
    return fan::graphics::physics::sprite_t(p);
  }
