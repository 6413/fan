...
layout(location = 1) in float layout_angle;
layout(location = 2) in vec2 layout_rotation_point;
layout(location = 3) in vec3 layout_rotation_vector;
layout(location = 4) in vec4 layout_color;
...
void main() {
    ...
    gl_Position = ubo.proj * ubo.view * m * vec4(1, 1, 0, 1);
