...
//}
//
//const uint8_t *vpx_video_reader_get_frame(video_reader_t *reader,
//                                          size_t *size) {
...
//
//      video_t(const std::string& file_path, properties_t& properties) {
//
...
//
//          if (out->pixel_data.pixels[0].empty()) {
//            const int stride = img->stride[0];
//            const int h = vpx_get_plane_size(img, 0).y;
//
//            out->pixel_data.pixels[0].resize(stride * h);
//            out->pixel_data.pixels[1].resize((stride * h) / 2);
//            out->pixel_data.pixels[2].resize((stride * h) / 2);
//          }
//
//          int plane;
//
