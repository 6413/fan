		...
		namespace gui {
			...
			struct theme {
				...
				struct button {
					...
					std::function<void(fan::window *window, uint32_t index, uint16_t key, fan::key_state key_state, mouse_stage mouse_stage)> m_click_callback = 
					[](fan::window *window, uint32_t index, uint16_t key, fan::key_state key_state, mouse_stage mouse_stage){};
					std::function<void(fan::window *window, uint32_t index, mouse_stage mouse_stage)> m_hover_callback = 
					[](fan::window *window, uint32_t index, mouse_stage mouse_stage){};
