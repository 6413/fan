...
//	namespace graphics {
//
//		static void draw_mode(fan::window* window, fill_mode_e fill_mode, face_e face) {
//
...
//		}
//
//		static fill_mode_e get_fill_mode(fan::window* window) {
//
//#if fan_renderer == fan_renderer_opengl
//
...
//		}
//
//		static fan_2d::graphics::face_e get_face(fan::window* window) {
//
//#if fan_renderer == fan_renderer_opengl
//
//			return polygon_face;
...
//		};
//
//		struct particles : protected fan_2d::graphics::sprite {
//
//			struct particle_t {
//				fan::vec2 position;
//				fan::vec2 size;
...
//			};
//
//			using fan_2d::graphics::sprite::sprite;
//
...
//					fan_2d::graphics::sprite::set_position(i, fan_2d::graphics::sprite::get_position(i) + m_physics[i].velocity * delta);
//				}
//				if (m_physics[i].angular_velocity != 0) {
//					fan_2d::graphics::sprite::set_angle(i, fan_2d::graphics::sprite::get_angle(i) + m_physics[i].angular_velocity * delta);
//				}
//				if (m_physics[i].fade_point != 0) {
//					fan_2d::graphics::sprite::set_transparency(i, 1.0 - ((f32_t)m_physics[i].erase_timer.elapsed() / m_physics[i].erase_timer.m_time) * m_physics[i].fade_point);
//				}
//				if (m_physics[i].erase_timer.finished()) {
//					fan_2d::graphics::sprite::erase(i);
