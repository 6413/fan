...
namespace fan_2d {
	...
	namespace physics {
		...
		public:
			...
			void add_rectangle(uint32_t collider_reference, fan_2d::physics::rectangle::properties_t properties) {
			...
			//				properties.angle += fan_2d::graphics::sprite::get_angle(sprite_node->graphics_nodereference);
			//				fan_2d::graphics::sprite::set_angle(sprite_node->graphics_nodereference, properties.angle);
			//			}
			...
			//	}
			//}
			void add_circle(uint32_t collider_reference, const fan_2d::physics::circle::properties_t& properties) {
	...
	/*	template <typename user_struct_t = fan_2d::physics::empty>
		...
		public:
			...
			void erase_graphics(uint32_t sprite_id) {
				...
				fan_2d::graphics::sprite::erase(ref);
			...
			fan::vec2 get_position(uint32_t sprite_id) const {
				...
				if (node.graphics_nodereference < fan_2d::graphics::sprite::size() && node.graphics_nodereference != (uint32_t)-1) {
					return fan_2d::graphics::sprite::get_position(node.graphics_nodereference);
				}
			...
			void set_position(uint32_t sprite_id, const fan::vec2& position) {
				...
				fan_2d::graphics::sprite::set_position(base_sprite_inherit_t::sprite_list[sprite_id].graphics_nodereference, position);
			}
