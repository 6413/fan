...
#define __dme2(varname) wrapper_t<dme_type_t, __COUNTER__ - DME_INTERNAL__BEG - 1> varname
#define __dme2_data(varname, data) wrapper_t<dme_type_t, __COUNTER__ - DME_INTERNAL__BEG - 1, \
...
struct base_t {
  ...
  constexpr dme_type_t* NA(unsigned long long I) const {
    return &((dme_type_t*)this)[I];
  }
