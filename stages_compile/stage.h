struct stage {
  ...
  struct stage0_t : stage_common_t_t<stage0_t> {
    ...
    //button_src
    button_mouse_button_cb_table_t button_mouse_button_cb_table[2] = {&stage0_t::button0_mouse_button_cb,&stage0_t::button1_mouse_button_cb,};
    button_mouse_move_cb_table_t button_mouse_move_cb_table[2] = {&stage0_t::button0_mouse_move_cb,&stage0_t::button1_mouse_move_cb,};
    button_keyboard_cb_table_t button_keyboard_cb_table[2] = {&stage0_t::button0_keyboard_cb,&stage0_t::button1_keyboard_cb,};
    button_text_cb_table_t button_text_cb_table[2] = {&stage0_t::button0_text_cb,&stage0_t::button1_text_cb,};
    //button_dst
  ...
  struct stage1_t : stage_common_t_t<stage1_t> {
    ...
    //button_src
    button_mouse_button_cb_table_t button_mouse_button_cb_table[1] = {&stage1_t::button1_mouse_button_cb,};
    button_mouse_move_cb_table_t button_mouse_move_cb_table[1] = {&stage1_t::button1_mouse_move_cb,};
    button_keyboard_cb_table_t button_keyboard_cb_table[1] = {&stage1_t::button1_keyboard_cb,};
    button_text_cb_table_t button_text_cb_table[1] = {&stage1_t::button1_text_cb,};
    //button_dst
