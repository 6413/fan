	...
	for(uint32_t iheight = 0; EXPECT(iheight < height, 1); iheight += 2){
		{
			...
			while(EXPECT(ddata01 != ddata01_limit, 1)){
				*ddata00++ = ((25 * sdata00[0] + 129 * sdata00[1] + 66 * sdata00[2]) >> 8) + 16;
				*ddata01++ = ((25 * sdata01[0] + 129 * sdata01[1] + 66 * sdata01[2]) >> 8) + 16;
				sdata01 += 4;
				sdata00 += 4;
			}
		}
