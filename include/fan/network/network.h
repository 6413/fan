...
//			skip:
//				if (path != std::string()) {
//					fan::io::file::write(path.c_str(), data, std::ios_base::binary);
//				}
//				else if (overwrite) {
//					fan::io::file::write(file_name.c_str(), data, std::ios_base::binary);
//				}
//				else {
//					fan::io::file::write(file_name.c_str(), data);
//				}
//
...
//			void m_send_vector(SOCKET socket, const std::vector<type_t>& vector) const {
//				std::string str(vector.begin(), vector.end());
//				m_send_message(socket, str);
//			}
//			template <typename type_t>
//			std::vector<type_t> m_get_vector(SOCKET socket) const {
//				std::string input = m_get_message(socket);
//				std::vector<type_t> data(input.begin(), input.end());
//				return data;
//			}
...
//
//			template <typename type_t>
//			inline void send_vector(SOCKET socket, const std::vector<type_t>& vector) const { return m_send_vector<type_t>(socket, vector); }
//			template <typename type_t>
//			inline std::vector<type_t> get_vector(SOCKET socket) const { return m_get_vector<type_t>(socket); }
...
//
//			template <typename type_t>
//			inline void send_vector(const std::vector<type_t>& vector) const { m_send_vector<type_t>(connect_socket, vector); }
//			template <typename type_t>
//			inline std::vector<type_t> get_vector() const { return m_get_vector<type_t>(connect_socket); }
//
