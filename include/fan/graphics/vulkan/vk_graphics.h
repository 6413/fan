...
namespace fan_2d {
	...
	namespace opengl {
		...
		public:
			...
			virtual void draw(fan_2d::opengl::shape shape, uint32_t single_draw_amount, uint32_t begin, uint32_t end) = 0;
		...
		protected:
			...
			// update when changing fan_2d::opengl::shape
		...
		struct vertice_vector : public basic_vertice_vector<vertex_instance_t> {
			...
			vertice_vector(fan::camera* camera) {
				...
				pipeline_offsets[(int)fan_2d::opengl::shape::line] = vk_instance->pipelines[(int)fan_2d::opengl::shape::line]->pipeline_info.size();

				vk_instance->pipelines[(int)fan_2d::opengl::shape::line]->push_back(
					binding_description,
				...
				pipeline_offsets[(int)fan_2d::opengl::shape::line_strip] = vk_instance->pipelines[(int)fan_2d::opengl::shape::line_strip]->pipeline_info.size();

				vk_instance->pipelines[(int)fan_2d::opengl::shape::line_strip]->push_back(
					binding_description,
					attribute_descriptions,
					camera->m_window->get_size(),
					shader_paths::vertice_vector_vs,
				...
				vk_instance->pipelines[(int)fan_2d::opengl::shape::triangle]->push_back(
					binding_description,
					attribute_descriptions,
					camera->m_window->get_size(),
					shader_paths::vertice_vector_vs,
				...
				pipeline_offsets[(int)fan_2d::opengl::shape::triangle_strip] = vk_instance->pipelines[(int)fan_2d::opengl::shape::triangle_strip]->pipeline_info.size();

				vk_instance->pipelines[(int)fan_2d::opengl::shape::triangle_strip]->push_back(
					binding_description,
					attribute_descriptions,
					camera->m_window->get_size(),
					shader_paths::vertice_vector_vs,
				...
				pipeline_offsets[(int)fan_2d::opengl::shape::triangle_fan] = vk_instance->pipelines[(int)fan_2d::opengl::shape::triangle_fan]->pipeline_info.size();

				vk_instance->pipelines[(int)fan_2d::opengl::shape::triangle_fan]->push_back(
					binding_description,
					attribute_descriptions,
					camera->m_window->get_size(),
					shader_paths::vertice_vector_vs,
				...
				fan_2d::opengl::shape* arr = new fan_2d::opengl::shape[(int)fan_2d::opengl::shape::last];

				for (int i = 0; i < (int)fan_2d::opengl::shape::last; i++) {
					arr[i] = (fan_2d::opengl::shape)i;
				}

				vk_instance->push_back_draw_call(arr, (int)fan_2d::opengl::shape::last, (void*)this, [&](uint32_t i, uint32_t j, void* base, fan_2d::opengl::shape shape) {
			...
			void draw(fan_2d::opengl::shape shape, uint32_t single_draw_amount, uint32_t begin, uint32_t end) {
				...
				if (m_camera->m_window->m_vulkan->set_draw_call_order(m_camera->m_window->m_vulkan->draw_order_id++, arr, (int)fan_2d::opengl::shape::last, (void*)this)) {
		...
		struct rectangle {
			...
			rectangle(fan::camera* camera) : m_camera(camera), m_begin(0), m_end(0), m_queue_helper(camera->m_window)
			{
				...
				pipeline_offset = vk_instance->pipelines[(int)fan_2d::opengl::shape::triangle]->pipeline_info.size();
				...
				vk_instance->push_back_draw_call(&shape, 1, (void*)this, [&](uint32_t i, uint32_t j, void* base, fan_2d::opengl::shape shape) {

					if (!instance_buffer->buffer->m_buffer_object || shape != fan_2d::opengl::shape::triangle || (uint64_t)base != (uint64_t)this) {
						return;
					}
		...
		struct line : protected fan_2d::opengl::rectangle {

		public:

			using fan_2d::opengl::rectangle::rectangle;
			...
			using fan_2d::opengl::rectangle::draw;
			using fan_2d::opengl::rectangle::edit_data;
			using fan_2d::opengl::rectangle::write_data;
			using fan_2d::opengl::rectangle::get_color;
			using fan_2d::opengl::rectangle::set_color;
			using fan_2d::opengl::rectangle::get_rotation_point;
			using fan_2d::opengl::rectangle::set_rotation_point;
			using fan_2d::opengl::rectangle::size;
		...
		struct sprite {
				...
				m_camera(camera), m_queue_helper(camera->m_window)
			{
				...
				pipeline_offset = camera->m_window->m_vulkan->pipelines[(int)fan_2d::opengl::shape::triangle]->pipeline_info.size();
			...
			/*void insert(uint32_t i, uint32_t texture_coordinates_i, std::unique_ptr<fan_2d::opengl::texture_id_handler>& handler, const fan::vec2& position, const fan::vec2& size, const sprite_properties& properties = sprite_properties()) {
