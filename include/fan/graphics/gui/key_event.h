...
//
//          keys_callback_id = window->add_keys_callback(this, [](fan::window_t* window, uint16_t key, fan::key_state state, void* userptr) {
...
//
//              for (uint32_t i = 0; i < cursor_vector.Current; i++) {
