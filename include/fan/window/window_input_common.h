static uint16_t convert_keycodes_to_fan(uint16_t key) {
    ...
    case 0x85: { return fan::input::key_left_super; }
...
static uint16_t convert_fan_to_keycodes(uint16_t key) {
  ...
  case fan::input::key_left_super: { return 0x5B; }
	...
	case key_numpad_multiply: { return 0x6A; }
	case key_numpad_add: { return 0x6B; }
	case key_numpad_separator: { return 0x6C; }
	case key_numpad_substract: { return 0x6D; }
	case key_numpad_decimal: { return 0x6E; }
	case key_numpad_divide: { return 0x6F; }
	...
	case key_f15: { return 0x7E; } // possibly tilde
	...
	case key_left_control: { return 0xA2; }
	case key_right_control: { return 0xA3; }

	case key_plus: { return 0xBB; }
	case key_comma: { return 0xBC; }
	case key_minus: { return 0xBD; }
	case key_period: { return 0xBE; }
	case key_apostrophe: { return 0xBF; }

#elif defined(fan_platform_unix)
  
  	case fan::input::button_left: { return 0x01; }
		case fan::input::button_middle: { return 0x02; }
		case fan::input::button_right: { return 0x03; }
		case fan::input::mouse_scroll_up: { return 0x04; }
		case fan::input::mouse_scroll_down: { return 0x05; }
		case fan::input::key_escape: { return 0x09; }
		case fan::input::key_f1: { return 0x43; }
		case fan::input::key_f2: { return 0x44; }
		case fan::input::key_f3: { return 0x45; }
		case fan::input::key_f4: { return 0x46; }
		case fan::input::key_f5: { return 0x47; }
		case fan::input::key_f6: { return 0x48; }
		case fan::input::key_f7: { return 0x49; }
		case fan::input::key_f8: { return 0x4A; }
		case fan::input::key_f9: { return 0x4B; }
		case fan::input::key_f10: { return 0x4C; }
		case fan::input::key_f11: { return 0x5F; }
		case fan::input::key_f12: { return 0x60; }
		case fan::input::key_scroll_lock: { return 0x4E; }
		case fan::input::key_pause: { return 0x7F; }
		case fan::input::key_tilde: { return 0x31; }
		case fan::input::key_0: { return 0x13; }
		case fan::input::key_1: { return 0x0A; }
		case fan::input::key_2: { return 0x0B; }
		case fan::input::key_3: { return 0x0C; }
		case fan::input::key_4: { return 0x0D; }
		case fan::input::key_5: { return 0x0E; }
		case fan::input::key_6: { return 0x0F; }
		case fan::input::key_7: { return 0x10; }
		case fan::input::key_8: { return 0x11; }
		case fan::input::key_9: { return 0x12; }
		case fan::input::key_exclamation_mark: { return 0x14; }
		case fan::input::key_apostrophe: { return 0x15; }
		case fan::input::key_backspace: { return 0x16; }
		case fan::input::key_insert: { return 0x76; }
		case fan::input::key_home: { return 0x6E; }
		case fan::input::key_page_up: { return 0x70; }
		case fan::input::key_tab: { return 0x17; }
		case fan::input::key_q: { return 0x18; }
		case fan::input::key_w: { return 0x19; }
		case fan::input::key_e: { return 0x1A; }
		case fan::input::key_r: { return 0x1B; }
		case fan::input::key_t: { return 0x1C; }
		case fan::input::key_y: { return 0x1D; }
		case fan::input::key_u: { return 0x1E; }
		case fan::input::key_i: { return 0x1F; }
		case fan::input::key_o: { return 0x20; }
		case fan::input::key_p: { return 0x21; }
		case fan::input::key_enter: { return 0x24; }
		case fan::input::key_delete: { return 0x77; }
		case fan::input::key_end: { return 0x73; }
		case fan::input::key_page_down: { return 0x75; }
		case fan::input::key_caps_lock: { return 0x42; }
		case fan::input::key_a: { return 0x26; }
		case fan::input::key_s: { return 0x27; }
		case fan::input::key_d: { return 0x28; }
		case fan::input::key_f: { return 0x29; }
		case fan::input::key_g: { return 0x2A; }
		case fan::input::key_h: { return 0x2B; }
		case fan::input::key_j: { return 0x2C; }
		case fan::input::key_k: { return 0x2D; }
		case fan::input::key_l: { return 0x2E; }
		case fan::input::key_semicolon: { return 0x2F; }
		case fan::input::key_quote: { return 0x33; }
		case fan::input::key_left_shift: { return 0x32; }
		case fan::input::key_angle: { return 0x5E; }
		case fan::input::key_z: { return 0x34; }
		case fan::input::key_x: { return 0x35; }
		case fan::input::key_c: { return 0x36; }
		case fan::input::key_v: { return 0x37; }
		case fan::input::key_b: { return 0x38; }
		case fan::input::key_n: { return 0x39; }
		case fan::input::key_m: { return 0x3A; }
		case fan::input::key_comma: { return 0x3B; }
		case fan::input::key_colon: { return 0x3C; }
		case fan::input::key_slash: { return 0x3D; }
		case fan::input::key_right_shift: { return 0x3E; }
		case fan::input::key_left_control: { return 0x25; }
		case fan::input::key_left_alt: { return 0x40; }
		case fan::input::key_space: { return 0x41; }
		case fan::input::key_right_alt: { return 0x6C; }
		case fan::input::key_left_super: { return 0x85; }
		...
		case fan::input::key_right: { return 0x72; }
		case fan::input::key_down: { return 0x74; }
		case fan::input::key_numpad_0: { return 0x5A; }
		case fan::input::key_numpad_1: { return 0x57; }
		case fan::input::key_numpad_2: { return 0x58; }
		case fan::input::key_numpad_3: { return 0x59; }
		case fan::input::key_numpad_4: { return 0x53; }
		case fan::input::key_numpad_5: { return 0x54; }
		case fan::input::key_numpad_6: { return 0x55; }
		case fan::input::key_numpad_7: { return 0x4F; }
		case fan::input::key_numpad_8: { return 0x50; }
		case fan::input::key_numpad_9: { return 0x51; }
		case fan::input::key_numpad_multiply: { return 0x3F; }
		case fan::input::key_numpad_add: { return 0x56; }
		case fan::input::key_numpad_substract: { return 0x52; }
		case fan::input::key_numpad_decimal: { return 0x5B; }
		case fan::input::key_numpad_divide: { return 0x6A; }
...
static uint16_t convert_utfkeys_to_fan(uint16_t key) {
	switch (key) {
		//shifts and ctrls require lparam check for which side the button is pressed this is usually checked before converting
#ifdef fan_platform_windows
		case 0x01: { return fan::input::button_left; }
