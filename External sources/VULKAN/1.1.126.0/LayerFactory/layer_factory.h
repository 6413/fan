...
class layer_factory {
    public:
        ...
        virtual VkResult PreCallWaitSemaphoresKHR(VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout) { PreCallApiFunction("vkWaitSemaphoresKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallWaitSemaphoresKHR(VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout, VkResult result) { PostCallApiFunction("vkWaitSemaphoresKHR", result); return VK_SUCCESS; };
        virtual VkResult PreCallSignalSemaphoreKHR(VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo) { PreCallApiFunction("vkSignalSemaphoreKHR"); return VK_SUCCESS; };
        virtual VkResult PostCallSignalSemaphoreKHR(VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo, VkResult result) { PostCallApiFunction("vkSignalSemaphoreKHR", result); return VK_SUCCESS; };
