...
inline void dump_head_vkSignalSemaphoreKHR(ApiDumpInstance& dump_inst, VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo)
{
    if (!dump_inst.shouldDumpOutput()) return ;
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_head_vkSignalSemaphoreKHR(dump_inst, device, pSignalInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_head_vkSignalSemaphoreKHR(dump_inst, device, pSignalInfo);
        break;
    case ApiDumpFormat::Json:
        dump_json_head_vkSignalSemaphoreKHR(dump_inst, device, pSignalInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_head_vkGetSemaphoreCounterValueKHR(ApiDumpInstance& dump_inst, VkDevice device, VkSemaphore semaphore, uint64_t* pValue)
{
    if (!dump_inst.shouldDumpOutput()) return ;
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_head_vkGetSemaphoreCounterValueKHR(dump_inst, device, semaphore, pValue);
        break;
    case ApiDumpFormat::Html:
        dump_html_head_vkGetSemaphoreCounterValueKHR(dump_inst, device, semaphore, pValue);
        break;
    case ApiDumpFormat::Json:
        dump_json_head_vkGetSemaphoreCounterValueKHR(dump_inst, device, semaphore, pValue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
#endif // VK_USE_PLATFORM_ANDROID_KHR
inline void dump_head_vkWaitSemaphoresKHR(ApiDumpInstance& dump_inst, VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout)
{
    if (!dump_inst.shouldDumpOutput()) return ;
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_head_vkWaitSemaphoresKHR(dump_inst, device, pWaitInfo, timeout);
        break;
    case ApiDumpFormat::Html:
        dump_html_head_vkWaitSemaphoresKHR(dump_inst, device, pWaitInfo, timeout);
        break;
    case ApiDumpFormat::Json:
        dump_json_head_vkWaitSemaphoresKHR(dump_inst, device, pWaitInfo, timeout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_body_vkSignalSemaphoreKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo)
{
    if (!dump_inst.shouldDumpOutput()) return;
    ...
    {
    case ApiDumpFormat::Text:
        dump_text_body_vkSignalSemaphoreKHR(dump_inst, result, device, pSignalInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_body_vkSignalSemaphoreKHR(dump_inst, result, device, pSignalInfo);
        break;
    case ApiDumpFormat::Json:
        dump_json_body_vkSignalSemaphoreKHR(dump_inst, result, device, pSignalInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_body_vkGetSemaphoreCounterValueKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSemaphore semaphore, uint64_t* pValue)
{
    if (!dump_inst.shouldDumpOutput()) return;
    ...
    {
    case ApiDumpFormat::Text:
        dump_text_body_vkGetSemaphoreCounterValueKHR(dump_inst, result, device, semaphore, pValue);
        break;
    case ApiDumpFormat::Html:
        dump_html_body_vkGetSemaphoreCounterValueKHR(dump_inst, result, device, semaphore, pValue);
        break;
    case ApiDumpFormat::Json:
        dump_json_body_vkGetSemaphoreCounterValueKHR(dump_inst, result, device, semaphore, pValue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
#endif // VK_USE_PLATFORM_ANDROID_KHR
inline void dump_body_vkWaitSemaphoresKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout)
{
    if (!dump_inst.shouldDumpOutput()) return;
    ...
    {
    case ApiDumpFormat::Text:
        dump_text_body_vkWaitSemaphoresKHR(dump_inst, result, device, pWaitInfo, timeout);
        break;
    case ApiDumpFormat::Html:
        dump_html_body_vkWaitSemaphoresKHR(dump_inst, result, device, pWaitInfo, timeout);
        break;
    case ApiDumpFormat::Json:
        dump_json_body_vkWaitSemaphoresKHR(dump_inst, result, device, pWaitInfo, timeout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkSignalSemaphoreKHR(VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo)
{
    dump_head_vkSignalSemaphoreKHR(ApiDumpInstance::current(), device, pSignalInfo);
    VkResult result = device_dispatch_table(device)->SignalSemaphoreKHR(device, pSignalInfo);
    
    dump_body_vkSignalSemaphoreKHR(ApiDumpInstance::current(), result, device, pSignalInfo);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore, uint64_t* pValue)
{
    dump_head_vkGetSemaphoreCounterValueKHR(ApiDumpInstance::current(), device, semaphore, pValue);
    VkResult result = device_dispatch_table(device)->GetSemaphoreCounterValueKHR(device, semaphore, pValue);
    
    dump_body_vkGetSemaphoreCounterValueKHR(ApiDumpInstance::current(), result, device, semaphore, pValue);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkWaitSemaphoresKHR(VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout)
{
    dump_head_vkWaitSemaphoresKHR(ApiDumpInstance::current(), device, pWaitInfo, timeout);
    VkResult result = device_dispatch_table(device)->WaitSemaphoresKHR(device, pWaitInfo, timeout);
    
    dump_body_vkWaitSemaphoresKHR(ApiDumpInstance::current(), result, device, pWaitInfo, timeout);
    return result;
}
